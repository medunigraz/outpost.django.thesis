...
@docstring_format(model=models.DoctoralSchool.__doc__)
...
@docstring_format(model=models.Discipline.__doc__)
...
@docstring_format(
    model=models.Thesis.__doc__, serializer=serializers.ThesisSerializer.__doc__
)
class ThesisViewSet(FlexFieldsMixin, ReadOnlyModelViewSet):
    ...
    filter_fields = ("doctoralschool", "discipline", "editors")
    permit_list_expands = ("doctoralschool", "discipline", "editors")
